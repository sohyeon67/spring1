					...
					<div class="card-body">
						<form method="post" action="/free/insert.do" id="freeForm" class="form-horizontal">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input name="freeTitle" id="freeTitle" type="text" class="form-control" value="${free.freeTitle }" placeholder="subject">
								</div>
...
$(function() {
	...
	addBtn.on("click", function() {
		...
		// 수정일 때 경로 변경
		if($(this).val() == "수정") {	// val() 괄호 까먹지 말기.. () 없으면 insert해버림
			freeForm.attr("action", "/free/update.do");
			// 수정일 때 hidden으로 글 번호 전달. post
		}
